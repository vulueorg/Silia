      ...
      <div className="topup-right-panel">
        <div className="topup-header">
          <button className="back-btn back-btn-mobile" onClick={() => navigate('/home')} aria-label="Go back">
            <svg width="12" height="18" viewBox="0 0 8 14" fill="none">
              <path d="M7 1L1 7l6 6" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
          <h1 className="topup-title">Wallet Top Up</h1>
        </div>
        ...
        <div className={`transfer-card${selected ? ' selected' : ''}`} onClick={() => setSelected(!selected)}>
          ...
          <div className="transfer-info">
            ...
            <p>To fund your Vulue account, make a bank transfer of up to ₦1,000,000.</p>
          </div>
        </div>
        ...
        <button
          ...
          onClick={() => selected && navigate('/bank-transfer')}
        >
          Confirm
        </button>
      </div>
