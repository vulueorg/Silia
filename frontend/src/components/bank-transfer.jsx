    ...
    <div className="bt-screen">
      ...
      <div className="bt-right-panel">
        <div className="bt-header">
          <button className="back-btn back-btn-mobile" onClick={() => navigate('/topup')} aria-label="Go back">
          ...
          <h1 className="bt-title">Wallet Top Up</h1>
        </div>
        ...
        <p className="amount-hint">
          ...
          <span className="hint-bold">₦10,000-max. ₦1,000,000 allowed at a time</span>
        ...
        {amount && (
          <div className="fee-card">
            ...
            <div className="fee-row">
              <span className="fee-label">Exact amount to be funded into your Vulue Wallet</span>
        ...
        {/* Saved account */}
        <p className="section-label-bt">Select saved accounts you are sending from:</p>
        ...
        <button
          ...
          onClick={() => {
            if (amount) {
              ...
              const funded = '₦' + (num * 1.01).toLocaleString()
              navigate('/transfer-confirm', { state: { fundedAmount: funded } })
            }
          }}
        >
          Confirm
